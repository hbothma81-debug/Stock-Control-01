...
export const S = {
  ...
  itemComment: { fontSize: 12.5, color: C.muted, fontStyle: "italic", marginTop: 2 },
  partTag: {
    fontFamily: F.mono,
    fontSize: 12,
    color: C.accentRaw,
  ...
  qtyNum: { fontFamily: F.mono, fontSize: 18, fontWeight: 600, lineHeight: 1 },
  qtyUnit: { fontFamily: F.mono, fontSize: 12, color: C.muted, marginTop: 2 },
  usageBtnUse: {
    padding: "8px 14px",
    borderRadius: 6,
    border: `1px solid ${C.danger}55`,
